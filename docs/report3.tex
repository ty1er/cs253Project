...
\subsubsection{Voldemort System Architecture}

In Figure \ref{sysarch}, it shows the logical architecture of Voldemort. Each layer implement a storage interface to support put, get, and delete 
...
\subsubsection{Voldemort Consistency}
